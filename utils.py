...
def draw_text(img, text,
    ...
    cv2.putText(img, text, (x, y + text_h + font_scale - 1), font, font_scale, (0,0,0), font_thickness)
    cv2.putText(img, text, (x, y + text_h + font_scale - 1), font, font_scale, text_color, int(font_thickness/3))
    return text_size
